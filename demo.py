...
def parse_arg():
    ...
    parser.add_argument('--image_path', type=str, default='img/000ae60d6d5e9cc885f67164b0bbbd22.jpg', help='the path to your image')
    parser.add_argument('--checkpoint', type=str, default='output\checkpoints\checkpoint_124_acc_1.0000.pth',
...
def recognition(config, img, model, converter, device):
    ...
    img = cv2.resize(img, (0, 0), fx=config.MODEL.IMAGE_SIZE.OW / w, fy=config.MODEL.IMAGE_SIZE.H / h, interpolation=cv2.INTER_CUBIC)
